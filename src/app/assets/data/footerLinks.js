export const footerLinks = {
  company: [
    ...
    { label: "Roaming Gnome Store", href: "/store" },
    { label: "Advertising", href: "/advertising" },
  ],
  explore: [
    { label: "Hotels in United States", href: "/explore/hotels-us" },
    { label: "Vacation Rentals", href: "/explore/vacation-rentals" },
    { label: "Vacation Packages", href: "/explore/packages" },
    { label: "Domestic Flights", href: "/explore/flights" },
    { label: "Car Rentals", href: "/explore/car-rentals" },
