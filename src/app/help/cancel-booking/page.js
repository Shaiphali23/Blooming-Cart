    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16 space-y-8">
        <p>
          ...
          change. You can cancel your booking according to our cancellation
          policy.
        </p>
        ...
        <div>
          ...
          <p>
            - Free cancellation is available up to 24 hours before your check-in
            date.
            <br />
            - Cancellations made within 24 hours of check-in may be subject to
            charges.
        ...
        <div>
          ...
          <ol className="mt-2 list-decimal list-inside space-y-2">
            ...
            <li>
              Click on the "Cancel Booking" button and follow the prompts.
            </li>
          </ol>
        </div>
        ...
        <div>
          ...
          <p>
            If you face any issues while cancelling your booking, please contact
            our support team:
          </p>
